  ...
  it.each([
    {
      ...
      declared: ["system.which", "codex.exec-server.stdio.v2", "system.run", "system.run"],
      allow: ["codex.exec-server.stdio.v2"],
      deny: ["system.run"],
      expected: ["codex.exec-server.stdio.v2", "system.which"],
    },
    {
      name: "withholds declared commands without explicit Gateway approval",
      declared: ["codex.exec-server.stdio.v2"],
      allow: [],
      deny: [],
      expected: [],
    },
    {
      ...
      declared: ["codex.exec-server.stdio.v2"],
      allow: ["codex.exec-server.stdio.v2"],
      deny: ["codex.exec-server.stdio.v2"],
      expected: [],
    },
    {
